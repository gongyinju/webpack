{
  template: '\
      <v-layout align-center justify-center>\
          ...
          <v-flex xs12 sm8 md4>\
            ...
            <router-link to="/async/detail"><v-btn class="primary">独立项目路由组件1</v-btn></router-link>\
            <router-link to="/async/componentA"><v-btn class="primary">独立项目外部组件路由2</v-btn></router-link>\
  ...
  methods: {
    ...
    loadData: function(){
      let self = this;
      this.$http('http://localhost:3000/api/products').then(function(res){
